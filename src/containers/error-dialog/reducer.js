...
const initialState = {
  desc: 'Senaste aktuell data är från 3/6 2018. Besök det skattefinansierade alternativet på MSB.se/skyddsrum för aktuell data. Skicka e-post till admin@hittaskyddsrum.se om du är intresserad av att ta över driften.',
